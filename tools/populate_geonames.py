...
"""
"""
Usage: cd blobapi && uv run python tools/populate_geonames.py
Requires: blobembed-duckdb, blobfilters-duckdb packages
          PG running at /tmp with gazetteer.geonames_place table
"""
import os
import sys
import time
